...
if (!process.env.DATABASE_URL) {
	console.error("❌ DATABASE_URL is required for PG seeding");
	process.exit(1);
}
...
const moviesData = [
	{
		...
		year: 1960,
		directorId: "fellini",
		genre: JSON.stringify(["Drama", "Comedy"]),
		synopsis:
	...
	},
	{
		...
		year: 1963,
		directorId: "fellini",
		genre: JSON.stringify(["Drama", "Fantasy"]),
		synopsis:
	...
	},
	{
		...
		genre: JSON.stringify(["Drama", "Sci-Fi"]),
		synopsis:
	...
	},
	{
		...
		year: 1972,
		directorId: "tarkovsky",
		genre: JSON.stringify(["Drama", "Mystery", "Sci-Fi"]),
		synopsis:
	...
	},
	{
		...
		year: 1968,
		directorId: "kubrick",
		genre: JSON.stringify(["Sci-Fi", "Adventure"]),
		synopsis:
	...
	},
	{
		...
		year: 1971,
		directorId: "kubrick",
		genre: JSON.stringify(["Crime", "Sci-Fi"]),
		synopsis:
	...
	},
	{
		...
		genre: JSON.stringify(["Mystery", "Romance", "Thriller"]),
		synopsis:
	...
	},
	{
		...
		year: 1960,
		directorId: "hitchcock",
		genre: JSON.stringify(["Horror", "Mystery", "Thriller"]),
		synopsis:
